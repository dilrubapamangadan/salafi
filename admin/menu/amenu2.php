            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="../index.php"><i class="fa fa-home fa-fw"></i> Home</a>                        </li>                      
					  
					  <li>
                            <a href="result.php"><i class="fa fa-check fa-fw"></i> Result<span class="fa arrow"></span></a>                        </li> 
<li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li><?php if(isset($_SESSION['uname'])){?>
                                    <a class="active" href="viewallalbums.php">View Album</a><?php }?>                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
...
<li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                  <?php if(isset($_SESSION['uname'])){?>  <a href="viewsgallery.php">View Gallery</a><?php }?>                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
