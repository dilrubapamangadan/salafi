...
imagejpeg($tmp,$filename,1000);
imagedestroy($src);
imagedestroy($tmp); // NOTE: PHP will clean up the temp file it created when the request
// has completed.
	$photo=$rd.$_FILES['upload']['name'];
	move_uploaded_file($_FILES["upload"]["tmp_name"],"../app/uploads/img/gallery/alb/".$rd.$_FILES["upload"]["name"]);


include "connect.php";

mysql_query("update tbl_album set image='$photo' where albumid = '$mykey1'");
