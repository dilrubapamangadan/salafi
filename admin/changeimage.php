...
// has completed.
	...
	move_uploaded_file($_FILES["upload"]["tmp_name"],"../app/uploads/img/gallery/g/".$_FILES["upload"]["name"]);


include "connect.php";

mysql_query("update tbl_events set images='$photo' where eventid = '$mykey1'");
