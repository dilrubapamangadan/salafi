...
$sql = "select * from tbl_gallery where status='process' ORDER BY albumid DESC LIMIT $start_from, 20";
...
<tbody>
                                        <tr>
                                            ...
                                            <td><a href='gchangeimage.php?key0=<?php echo  $row["gid"];?>'><img src="acatch/<?php echo $row["gimages"]; ?>"  width="100px"/></a></td>
                                           <td><a href='gallerydelete.php?key1=<?php echo $row["gid"]; ?>'>Delete</a>  
