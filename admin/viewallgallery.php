...
$sql = "select * from tbl_gallery where status='process' ORDER BY gid DESC LIMIT $start_from, 20";
...
<tbody>
                                        <tr>
                                            ...
                                            <td><a href='gchangeimage.php?key0=<?php echo  $row["gid"];?>'><img src="gupload/<?php echo $row["gimages"]; ?>"  width="100px"/></a></td>
